...
/**
 * PUT /user/settings
 * Salva o JSON inteiro (não é o que o painel usa, mas deixei aqui)
 */
 ...
 * (é exatamente esse endpoint que o conta.html chama)
 */
...
router.post(
  ...
  async (req, res, next) => {
    try {
      ...
      // URL pública via /uploads (configurado em server.js)
      const avatarUrl = `${
